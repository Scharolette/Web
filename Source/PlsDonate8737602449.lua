...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Scharolette/Web/main/Source/PlsDonate8737602449.lua'))()")
...
Players.LocalPlayer.leaderstats.Raised.Changed:Connect(function()
    ...
    if getgenv().settings.webhookToggle and getgenv().settings.webhookBox then
        ...
        webhook(tostring("💰 Somebody gave ".. Players.LocalPlayer.leaderstats.Raised.value - RaisedC.. " robux to ".. Players.LocalPlayer.DisplayName.. " (Total on that account: " .. Players.LocalPlayer.leaderstats.Raised.value.. ")"))
    end
